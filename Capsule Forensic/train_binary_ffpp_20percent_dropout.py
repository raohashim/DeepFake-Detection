...
parser.add_argument('--dataset', default ='/content/drive/MyDrive/Hashim/CapsuleNet/Capsule-Forensics-v2/databases/faceforensicspp', help='path to root dataset')
...
parser.add_argument('--outf', default='/content/drive/MyDrive/Hashim/CapsuleNet/Capsule-Forensics-v2/checkpoints/binary_faceforensicspp', help='folder to output model checkpoints')
parser.add_argument('--disable_random', action='store_true', default=False, help='disable randomness for routing matrix')
parser.add_argument('--dropout', type=float, default=0.20, help='dropout percentage')
